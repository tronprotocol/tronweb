...
/**
 * Precise variant of the chain-reading APIs, reachable as `tronWeb.trx.precise`.
 *
 ...
 * {@link BaseTrx} docs for the pinned list).
 *
 ...
 */
export class PreciseTrx extends BaseTrx<true> {
