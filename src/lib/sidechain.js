...
//     constructor(sideOptions, AccWeb = false, mainchain = false, privateKey = false) {
//         this.mainchain = mainchain;
//         const { fullHost, fullNode, solidityNode, eventServer, mainGatewayAddress, sideGatewayAddress, sideChainId } = sideOptions;
//         this.sidechain = new AccWeb(fullHost || fullNode, fullHost || solidityNode, fullHost || eventServer, privateKey);
...
//     async sign(transaction = false, privateKey = this.sidechain.defaultPrivateKey, useAccWeb = true, multisig = false, callback = false) {
//         if (this.utils.isFunction(multisig)) {
//             callback = multisig;
//             multisig = false;
//         }

//         if (this.utils.isFunction(useAccWeb)) {
//             callback = useAccWeb;
//             useAccWeb = true;
//             multisig = false;
//         }
...
//             try {
//                 const signatureHex = this.sidechain.trx.signString(transaction, privateKey, useAccWeb);
