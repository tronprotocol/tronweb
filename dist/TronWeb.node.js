          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 14:
                ...
                this.tronWeb.transactionBuilder.triggerSmartContract(this.contract.address, this.functionSelector, options, parameters, this.tronWeb.address.toHex(options.from), function (err, transaction) {
...
function () {
  function TransactionBuilder() {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, TransactionBuilder);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(TransactionBuilder, [{
    key: "sendTrx",
    value: function sendTrx() {
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(from)) {
        callback = from;
        from = this.tronWeb.defaultAddress.hex;
      }
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(amount) || amount <= 0) return callback('Invalid amount provided');
    ...
    value: function sendToken() {
      ...
      if (!this.tronWeb.isAddress(to)) return callback('Invalid recipient address provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(amount) || amount <= 0) return callback('Invalid amount provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(tokenID) || !tokenID.length) return callback('Invalid token ID provided');
      if (!this.tronWeb.isAddress(from)) return callback('Invalid origin address provided');
      to = this.tronWeb.address.toHex(to);
    ...
    value: function purchaseToken() {
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(buyer)) {
        callback = buyer;
    ...
    value: function freezeBalance() {
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(receiverAddress)) {
        callback = receiverAddress;
        receiverAddress = undefined;
      }

      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(address)) {
        callback = address;
        address = this.tronWeb.defaultAddress.hex;
      }

      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(duration)) {
        callback = duration;
        duration = 3;
      }

      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(resource)) {
        callback = resource;
        resource = "BANDWIDTH";
      }
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(amount) || amount <= 0) return callback('Invalid amount provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(duration) || duration < 3) return callback('Invalid duration provided, minimum of 3 days');
      if (!this.tronWeb.isAddress(address)) return callback('Invalid address provided');
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(receiverAddress) && !this.tronWeb.isAddress(receiverAddress)) return callback('Invalid receiver address provided');
      var data = {
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(receiverAddress)) {
    ...
    value: function applyForSR() {
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isValidURL(address)) {
        callback = url || false;
        url = address;
        address = this.tronWeb.defaultAddress.hex;
      }
      ...
      if (!this.tronWeb.isAddress(address)) return callback('Invalid address provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isValidURL(url)) return callback('Invalid url provided');
    ...
    value: function vote() {
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(voterAddress)) {
        callback = voterAddress;
        voterAddress = this.tronWeb.defaultAddress.hex;
      }

      if (!callback) return this.injectPromise(this.vote, votes, voterAddress);
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isObject(votes) || !Object.keys(votes).length) return callback('Invalid votes object provided');
      ...
      votes = Object.entries(votes).map(function (_ref) {
        ...
        if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(voteCount) || voteCount <= 0) {
    ...
    value: function createSmartContract() {
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(issuerAddress)) {
        callback = issuerAddress;
        issuerAddress = this.tronWeb.defaultAddress.hex;
      }

      if (!callback) return this.injectPromise(this.createSmartContract, options, issuerAddress);
      var feeLimit = options.feeLimit || 1000000000;
      var userFeePercentage = options.userFeePercentage || 100;
      ...
      if (abi && utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(abi)) {
        try {
          abi = JSON.parse(abi);
        } catch (_unused) {
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isArray(abi)) return callback('Invalid options.abi provided');
      var payable = abi.some(function (func) {
        return func.type == 'constructor' && func.payable;
      });
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isHex(bytecode)) return callback('Invalid options.bytecode provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(feeLimit) || feeLimit <= 0 || feeLimit > 1000000000) return callback('Invalid options.feeLimit provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(callValue) || callValue < 0) return callback('Invalid options.callValue provided');
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(userFeePercentage) || userFeePercentage < 0 || userFeePercentage > 100) return callback('Invalid options.userFeePercentage provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(originEnergyLimit) || originEnergyLimit < 0 || originEnergyLimit > 10000000) return callback('Invalid options.originEnergyLimit provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isArray(parameters)) return callback('Invalid parameters provided');
      if (!this.tronWeb.isAddress(issuerAddress)) return callback('Invalid issuer address provided');
      var constructorParams = abi.find(function (it) {
        return it.type === 'constructor';
      });
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(tokenValue) && (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(tokenValue) || tokenValue < 0)) return callback('Invalid options.tokenValue provided');
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(tokenId) && (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(tokenId) || tokenId < 0)) return callback('Invalid options.tokenValue provided');

      if (typeof constructorParams !== 'undefined' && constructorParams) {
        var abiCoder = new ethers__WEBPACK_IMPORTED_MODULE_7__["utils"].AbiCoder();
        var types = [];
        var values = [];
        ...
        for (var i = 0; i < parameters.length; i++) {
          ...
          if (!type || !utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(type) || !type.length) return callback('Invalid parameter type provided: ' + type);
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(tokenValue)) args.call_token_value = parseInt(tokenValue);
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(tokenId)) args.token_id = parseInt(tokenId);
    ...
    value: function triggerSmartContract() {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(params[2]) !== 'object') {
        params[2] = {
          feeLimit: params[2],
          callValue: params[3]
        };
    ...
    value: function _triggerSmartContract(contractAddress, functionSelector) {
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(parameters)) {
        callback = parameters;
        parameters = [];
      }
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(functionSelector) || !functionSelector.length) return callback('Invalid function selector provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(callValue) || callValue < 0) return callback('Invalid call value provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(feeLimit) || feeLimit <= 0 || feeLimit > 1000000000) return callback('Invalid fee limit provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isArray(parameters)) return callback('Invalid parameters provided');
      if (!this.tronWeb.isAddress(issuerAddress)) return callback('Invalid issuer address provided');
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(tokenValue)) args.call_token_value = parseInt(tokenValue);
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(tokenId)) args.token_id = parseInt(tokenId);
      this.tronWeb.fullNode.request('wallet/triggersmartcontract', args, 'post').then(function (transaction) {
        return transactionResultManager(transaction, callback);
      }).catch(function (err) {
        return callback(err);
      });
    ...
    value: function createToken() {
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(name) || !name.length) return callback('Invalid token name provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(abbreviation) || !abbreviation.length) return callback('Invalid token abbreviation provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(totalSupply) || totalSupply <= 0) return callback('Invalid supply amount provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(trxRatio) || trxRatio <= 0) return callback('TRX ratio must be a positive integer');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(tokenRatio) || tokenRatio <= 0) return callback('Token ratio must be a positive integer');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(saleStart) || saleStart < Date.now()) return callback('Invalid sale start timestamp provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(saleEnd) || saleEnd <= saleStart) return callback('Invalid sale end timestamp provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(description) || !description.length) return callback('Invalid token description provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(url) || !url.length || !utils__WEBPACK_IMPORTED_MODULE_6__["default"].isValidURL(url)) return callback('Invalid token url provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(freeBandwidth) || freeBandwidth < 0) return callback('Invalid free bandwidth amount provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(freeBandwidthLimit) || freeBandwidthLimit < 0 || freeBandwidth && !freeBandwidthLimit) return callback('Invalid free bandwidth limit provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(frozenAmount) || frozenAmount < 0 || !frozenDuration && frozenAmount) return callback('Invalid frozen supply provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(frozenDuration) || frozenDuration < 0 || frozenDuration && !frozenAmount) return callback('Invalid frozen duration provided');
      if (!this.tronWeb.isAddress(issuerAddress)) return callback('Invalid issuer address provided');
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(voteScore) && (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(voteScore) || voteScore <= 0)) return callback('voteScore must be a positive integer greater than 0');
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isNotNullOrUndefined(precision) && (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(precision) || precision <= 0 || precision > 6)) return callback('precision must be a positive integer > 0 and <= 6');
      var data = {
        owner_address: this.tronWeb.address.toHex(issuerAddress),
    ...
    value: function updateAccount() {
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(accountName) || !accountName.length) {
    ...
    value: function createProposal() {
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isArray(parameters)) parameters = [parameters];
      ...
      try {
        for (var _iterator = parameters[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isObject(parameter)) return callback(invalid);
        }
      } catch (err) {
    ...
    value: function deleteProposal() {
      ...
      if (!this.tronWeb.isAddress(issuerAddress)) return callback('Invalid issuerAddress provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(proposalID) || proposalID < 0) return callback('Invalid proposalID provided');
    ...
    value: function voteProposal() {
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(proposalID) || proposalID < 0) return callback('Invalid proposalID provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isBoolean(isApproval)) return callback('Invalid hasApproval provided');
    ...
    value: function createTRXExchange(tokenName, tokenBalance, trxBalance) {
      ...
      if (utils__WEBPACK_IMPORTED_MODULE_6__["default"].isFunction(ownerAddress)) {
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(tokenName) || !tokenName.length) return callback('Invalid tokenName provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(tokenBalance) || tokenBalance <= 0 || !utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(trxBalance) || trxBalance <= 0) return callback('Invalid amount provided');
    ...
    value: function createTokenExchange(firstTokenName, firstTokenBalance, secondTokenName, secondTokenBalance) {
      ...
      if (!this.tronWeb.isAddress(ownerAddress)) return callback('Invalid address provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(firstTokenName) || !firstTokenName.length) return callback('Invalid firstTokenName provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(secondTokenName) || !secondTokenName.length) return callback('Invalid secondTokenName provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(firstTokenBalance) || firstTokenBalance <= 0 || !utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(secondTokenBalance) || secondTokenBalance <= 0) return callback('Invalid amount provided');
      this.tronWeb.fullNode.request('wallet/exchangecreate', {
        owner_address: this.tronWeb.address.toHex(ownerAddress),
    ...
    value: function injectExchangeTokens() {
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(exchangeID) || exchangeID < 0) return callback('Invalid exchangeID provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(tokenName) || !tokenName.length) return callback('Invalid tokenName provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(tokenAmount) || tokenAmount < 1) return callback('Invalid tokenAmount provided');
    ...
    value: function tradeExchangeTokens() {
      ...
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(exchangeID) || exchangeID < 0) return callback('Invalid exchangeID provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isString(tokenName) || !tokenName.length) return callback('Invalid tokenName provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(tokenAmountSold) || tokenAmountSold < 1) return callback('Invalid tokenAmountSold provided');
      if (!utils__WEBPACK_IMPORTED_MODULE_6__["default"].isInteger(tokenAmountExpected) || tokenAmountExpected < 1) return callback('Invalid tokenAmountExpected provided');
