...
/* harmony import */ var js_sha3__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! js-sha3 */ "js-sha3");
...
function (_EventEmitter) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(TronWeb, [{
    ...
    value: function isEventServerConnected() {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_13___default.a.get(this.eventServer.replace(/\/+$/, '') + '/healthcheck').then(function () {
        return true;
      }).catch(function () {
        return axios__WEBPACK_IMPORTED_MODULE_13___default.a.get(_this2.eventServer.replace(/\/+$/, '') + '/events?size=1').then(function (_ref) {
          var data = _ref.data;
