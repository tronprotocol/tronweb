  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(Trx, [{
    ...
    value: function sendRawTransaction() {
      ...
      this.tronWeb.fullNode.request('wallet/broadcasttransaction', signedTransaction, 'post').then(function (result) {
        ...
        if (result.result) {
          var timeout = Date.now() + 6e4; // 1 minutes
              ...
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.next = 2;
                      return _this5.tronWeb.trx.getTransactionInfo(signedTransaction.txID);

                    case 2:
                      transaction = _context4.sent;

                      if (Date.now() < timeout && (!utils__WEBPACK_IMPORTED_MODULE_9__["default"].isObject(transaction) || !transaction.blockNumber)) {
                        _this5.tronWeb.fullNode.request('wallet/broadcasttransaction', signedTransaction, 'post').then(function (result) {}).catch(function (err) {});
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                callback = _args5.length > 3 && _args5[3] !== undefined ? _args5[3] : false;
                ...
                return _context5.abrupt("return", this.injectPromise(this.sendTransaction, to, amount, options));
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                to = _args6.length > 0 && _args6[0] !== undefined ? _args6[0] : false;
                amount = _args6.length > 1 && _args6[1] !== undefined ? _args6[1] : false;
                tokenID = _args6.length > 2 && _args6[2] !== undefined ? _args6[2] : false;
                ...
                return _context6.abrupt("return", this.injectPromise(this.sendToken, to, amount, tokenID, options));
              ...
              case 9:
                ...
                return _context6.abrupt("return", callback('Invalid recipient provided'));
              ...
              case 13:
                ...
                return _context6.abrupt("return", callback('Invalid token ID provided'));
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                amount = _args7.length > 0 && _args7[0] !== undefined ? _args7[0] : 0;
                duration = _args7.length > 1 && _args7[1] !== undefined ? _args7[1] : 3;
                resource = _args7.length > 2 && _args7[2] !== undefined ? _args7[2] : "BANDWIDTH";
                options = _args7.length > 3 && _args7[3] !== undefined ? _args7[3] : {};
                callback = _args7.length > 4 && _args7[4] !== undefined ? _args7[4] : false;
                ...
                return _context7.abrupt("return", this.injectPromise(this.freezeBalance, amount, duration, resource, options));
              ...
              case 15:
                ...
                return _context7.abrupt("return", callback('Invalid duration provided, minimum of 3 days'));
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                resource = _args8.length > 0 && _args8[0] !== undefined ? _args8[0] : "BANDWIDTH";
                ...
                return _context8.abrupt("return", this.injectPromise(this.unfreezeBalance, resource, options));
              ...
              case 8:
                ...
                return _context8.abrupt("return", callback('Invalid resource provided: Expected "BANDWIDTH" or "ENERGY"'));
              ...
              case 17:
                unfreezeBalance = _context8.sent;
                _context8.next = 20;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                accountName = _args9.length > 0 && _args9[0] !== undefined ? _args9[0] : false;
                options = _args9.length > 1 && _args9[1] !== undefined ? _args9[1] : {};
                callback = _args9.length > 2 && _args9[2] !== undefined ? _args9[2] : false;
                ...
                return _context9.abrupt("return", this.injectPromise(this.updateAccount, accountName, options));
              ...
              case 7:
                ...
                return _context9.abrupt("return", callback('Name must be a string'));
    ...
    value: function listProposals() {
      ...
      this.tronWeb.fullNode.request('wallet/listproposals', {}, 'post').then(function (_ref18) {
        var _ref18$proposals = _ref18.proposals,
            proposals = _ref18$proposals === void 0 ? [] : _ref18$proposals;
    ...
    value: function getChainParameters() {
      ...
      this.tronWeb.fullNode.request('wallet/getchainparameters', {}, 'post').then(function (_ref19) {
        var _ref19$chainParameter = _ref19.chainParameter,
            chainParameter = _ref19$chainParameter === void 0 ? [] : _ref19$chainParameter;
    ...
    value: function listExchanges() {
      ...
      this.tronWeb.fullNode.request('wallet/listexchanges', {}, 'post').then(function (_ref20) {
