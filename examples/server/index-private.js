...
const fullNode = new HttpProvider('http://127.0.0.1:16667');
const solidityNode = new HttpProvider('http://127.0.0.1:16668');
const eventServer = 'https://api.trongrid.io/';
const privateKey = 'da146374a75310b9666e834ee4ad0866d6f4035967bfc76217c5a495fff9f0d0';
...
const app = async () => {
    ...
    try {
      const transaction = await tronWeb.trx.getTransaction('97deca69c9b4d358092835c50690d2ce39f91daaa4a8b42f76ce1c2514930fb4');
    ...
    const transactions = await tronWeb.trx.getTransactionsRelated('TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY', 'all');

    console.group('Transactions relating to address');
        console.log('- Address: TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY');
        console.log('- Transactions:\n' + JSON.stringify(transactions, null, 2), '\n');
    console.groupEnd();

  //   const bAccount = await tronWeb.toHex('TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY')
  ...
  // return
    ...
    const balance = await tronWeb.trx.getBalance('TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY');
    ...
    const bandwidth = await tronWeb.trx.getBandwidth('TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY');
    ...
    try {
      ...
      console.error('Error with nextVoleCycle', err.message)
    }
    ...
    try {
      ...
      console.groupEnd();
        ...
        console.error('Error with getContract', err.message)
    }

    const sendTransaction = await tronWeb.transactionBuilder.sendTrx('TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY', 10);

    console.group('Unsigned send TRX transaction');
        console.log('- Recipient: TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY');
        console.log('- Transaction:\n' + JSON.stringify(sendTransaction, null, 2), '\n');
    console.groupEnd();

    // There are no tokens on the network yet
    // const sendToken = await tronWeb.transactionBuilder.sendToken('TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY', 10, 'TestToken_1');
    // 
    ...
    tronWeb.trx.sendTransaction('TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY', 10, (err, result) => {
        if(err)
            return console.error(err);
    ...
    tronWeb.trx.sendToken('TPL66VK2gCXNCD7EJg9pgJRfqcRazjhUZY', 10, 'TestToken_1', (err, result) => {
        if(err)
            return console.error(err);
